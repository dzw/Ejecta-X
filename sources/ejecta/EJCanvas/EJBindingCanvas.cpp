...
EJBindingCanvas::EJBindingCanvas(JSContextRef ctx, JSObjectRef obj, size_t argc,
                                 const JSValueRef argv[]) : renderingContext(0), isScreenCanvas(false)
{
    ejectaInstance = EJApp::instance();
    scalingMode = kEJScalingModeFitWidth;
    useRetinaResolution = true;
...
EJ_BIND_ENUM_GETTER(EJBindingCanvas, globalCompositeOperation, EJCompositeOperation,
                    renderingContext->getGlobalCompositeOperation);
EJ_BIND_ENUM_SETTER(EJBindingCanvas, globalCompositeOperation, EJCompositeOperation,
                    renderingContext->setGlobalCompositeOperation);
